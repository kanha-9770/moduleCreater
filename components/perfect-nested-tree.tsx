...
interface PerfectNestedTreeProps {
  modules: FormModule[]
...
function TreeNode({
  ...
  return (
    <div className="select-none">
      {/* Module Row */}
      <div
        className="group flex items-center gap-2 py-1.5 px-2 hover:bg-blue-50 transition-colors cursor-pointer rounded-md mx-1 relative"
        ...
        <div className="relative">
          ...
          {hasForms &&
            module.forms.map((form: Form, index) => (
              <div
                key={form.id}
                className="group flex items-center gap-2 py-1 px-2 hover:bg-green-50 transition-colors rounded-md mx-1 relative"
                style={{ paddingLeft: 8 + (level + 1) * 24 }}
              >
...
export default function PerfectNestedTree({
  modules,
  onEditModule,
  onDeleteModule,
  onCreateSubModule,
  onCreateForm = () => {},
}: PerfectNestedTreeProps) {
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                Perfect nested structure - Right-click to create forms & submodules
              </p>
            </div>
          </div>
